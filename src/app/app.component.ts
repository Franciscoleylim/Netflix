...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'Agregar Cliente', component: ListPage },
      { title: 'Buscar Cliente', component: BuscarClientePage },
      { title: 'Buscar Cuenta', component: BuscarCuentaPage },
      { title: 'Auto Prueba', component: WhatsappAutoPage }
    ];
